    ...
    <InputWrapper>
      ...
      >
        <input
          ...
          {...register}
        />
        <button className='ml-auto flex h-8 w-[5.1875rem] flex-nowrap items-center justify-center rounded-lg border border-gray30 bg-white px-3 py-[0.5625rem] text-xs text-violet'>
          입력
        </button>
      </div>
