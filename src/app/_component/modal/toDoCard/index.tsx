      ...
      {modalType ? (
        ...
        <>
          <div onClick={modalOutSideClick}>
            ...
            >
              <div
                className='hide-scrollbar relative flex h-[75%] flex-col gap-4 overflow-scroll rounded-lg border bg-white sm:w-[20.4375rem] sm:px-[1.25rem] sm:pb-[2.5rem] md:w-[42.5rem] md:gap-6 md:px-[1.75rem] md:pb-[2rem] lg:w-[45.625rem]'
                onClick={handleKebabClose}
              >
                <div className='sticky top-0 flex w-full justify-between bg-white sm:pt-[2.5rem] md:pt-[2rem]'>
