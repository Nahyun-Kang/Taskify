...
function Label({ titleText, isRequired, htmlFor }: LabelProps) {
  return (
...
export default function InputField({
  ...
  return (
    <InputWrapper>
      <Label titleText={titleText} isRequired={isRequired} htmlFor={id} />
      <input id={id} type={type} className={getInputClass(hasError)} placeholder={placeholder} />
    </InputWrapper>
  );
}

function TagInput({ initialTags = [], titleText, placeholder, id, hasError }: TagInputProps) {
  ...
  return (
    <InputWrapper>
      <Label titleText={titleText} isRequired={false} htmlFor={id} />
      <div
...
function PasswordInput({ titleText, placeholder, id, hasError = false, errorMessage }: CommonInputProps) {
...
function DateInput({ titleText, id, hasError = false }: { titleText: string; id: string; hasError?: boolean }) {
...
function CommentInput({ titleText, id, hasError = false, placeholder, handleClick }: CommentInputProps) {
  return (
    <InputWrapper>
      <Label titleText={titleText} isRequired={false} htmlFor={id} />
      <div
