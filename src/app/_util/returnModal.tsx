...
export default function returnModal(
  ...
  switch (modalName) {
    case '새 칼럼 생성':
      return <Modal createColumn btnName='생성' setModalType={setModalType} btnSize='large' />;
    case '칼럼 관리':
      return <Modal updateOrDeleteColumn btnName='변경' setModalType={setModalType} btnSize='large' />;
    case '할 일 생성':
    ...
    case '할 일 삭제':
      return <Modal deleteToDo btnName='삭제' setModalType={setModalType} btnSize='large' />;
    case '할 일 카드 상세':
      return <Modal detailToDo btnName='?' setModalType={setModalType} btnSize='large' layout='big' />;
  }
}
